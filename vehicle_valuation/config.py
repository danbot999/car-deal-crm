...
LIVE_SEARCH_BUDGET_SECONDS = int(os.getenv("VALUATION_LIVE_BUDGET_SECONDS", "180"))
SOURCE_TIMEOUT_SECONDS = int(os.getenv("VALUATION_SOURCE_TIMEOUT_SECONDS", "30"))
MAX_SOURCE_WORKERS = int(os.getenv("VALUATION_SOURCE_WORKERS", "6"))
MAX_GROUP_WORKERS = int(os.getenv("VALUATION_GROUP_WORKERS", "6"))
SEARCH_CACHE_HOURS = int(os.getenv("VALUATION_SEARCH_CACHE_HOURS", "24"))
MAX_PORTAL_PAGES = int(os.getenv("VALUATION_MAX_PORTAL_PAGES", "100"))
